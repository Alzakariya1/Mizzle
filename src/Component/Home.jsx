        ...
        <>
            <section className="position-relative overflow-hidden pb-0 pt-xl-9">
                ...
                <div className="position-absolute top-0 start-0 ms-n7 d-none d-xl-block">
                    <img src="/Image/element/decoration-pattern.svg" alt="" />
                </div>
                {/* SVG decoration */}
                <figure className="position-absolute top-0 end-0 me-n4 mt-n7 d-none d-xl-block">
                    <svg
                        ...
                        height="834px"
                        viewBox="0 0 775 834"
                        style={{ enableBackground: "new 0 0 775 834" }}
                        xmlSpace="preserve"
                    >
                        ...
                        <div className="col-md-10 col-xl-5 position-relative mx-auto mt-7 mt-xl-0">
                            ...
                            <figure className="position-absolute top-0 start-0 translate-middle mt-2">
                                <svg
                                    ...
                                    style={{ enableBackground: "new 0 0 124.2 76.9" }}
                                    xmlSpace="preserve"
                                >
                                    <path
                                        className="fill-mode"
                            ...
                            <div className="d-inline-block card card-body shadow rounded-4 position-absolute end-0 top-0 p-3 me-lg-n3 me-xxl-n7 mt-n5 d-none d-sm-block">
                                ...
                                />
                                <img
                                    src="/Image/element/trustpilot-light.svg"
                                    className="dark-mode-item h-20px mb-2"
                                    alt="Client-img"
                                />
                                <div className="d-flex align-items-center">
                                    <img
                                        src="/Image/element/trustpilot-star.svg"
                                        className="h-30px"
                                        alt="rating-img"
                                    />
