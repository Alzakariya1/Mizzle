                    ...
                    <div className="row g-4 g-xl-6 align-items-center">
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="col-10 mt-4">
                                <form className="position-relative">
                                    <input
                                        className="form-control form-control-lg bg-light ps-6"
                                        type="search"
                                    ...
                                    <button
                                        ...
                                        type="submit"
                                    >
                                        <i className="bi bi-search fs-6"><IoSearchSharp /> </i>
                                    </button>
                                </form>
                            </div>
                        </div>
                        ...
                        <div className="col-md-6">
                            ...
                            >
                                ...
                                <path
                                    className="fill-body"
                                    d="M439.8,294.7L327.1,295l58.2-89.4l112.8-0.1L439.8,294.7z"
                                />
                                <path
                                    className="fill-mode opacity-9"
                        ...
                        <div className="col-md-10 mx-auto">
                            ...
                            >
                                ...
                                <div className="accordion-item mb-3">
                                    ...
                                    >
                                        <div className="accordion-body mt-3 pb-0">
                                            Was out laughter raptures returned outweigh. Luckily cheered
                                            colonel I do we attack highest enabled. Tried law yet style
                                            child. The bore of true of no be deal. Drawings offended yet
                                            answered Jennings perceive laughing six did far. Rooms oh fully
                                            taken by worse do. Points afraid but may end law lasted.
                                        </div>
                                    </div>
                                </div>
                                {/* Item */}
                                <div className="accordion-item mb-3">
                                    ...
                                    >
                                        <div className="accordion-body mt-3">
                                            September how men saw tolerably two behavior arranging. She
                                            offices for highest and replied one venture pasture. Applauded
                                            no discovery in newspaper allowance am northward. Frequently
                                            partiality possession resolution at or appearance unaffected me.
                                            Engaged its was the evident pleased husband. Ye goodness
                                            felicity do disposal dwelling no. First am plate jokes to began
                                            to cause a scale. Subjects he prospect elegance followed no
                                            overcame possible it on. Improved own provided blessing may
                                            peculiar domestic. Sight house has sex never. No visited raising
                                ...
                                <div className="accordion-item mb-3">
                                    ...
                                    >
                                        <div className="accordion-body mt-3">
                                            Agencies provide a wide range of services depending on their
                                            specialization. Some common services include advertising
                                            campaigns, digital marketing, branding, creative design, media
                                            planning and buying, public relations, talent management, event
                                ...
                                <div className="accordion-item mb-3">
                                    ...
                                    >
                                        <div className="accordion-body mt-3">
                                            When selecting an agency, consider your specific requirements,
                                            budget, and the agency's expertise and track record in your
                                            industry. Research their portfolio, client testimonials, and
                                            case studies to gauge their capabilities. It's also important to
                                            meet with the agency to assess their communication style and
                                ...
                                <div className="accordion-item mb-3">
                                    ...
                                    >
                                        <div className="accordion-body mt-3">
                                            Hiring an agency offers several benefits, such as access to
                                            specialized skills and expertise, industry insights, creative
                                            thinking, established networks, and resources. Agencies can
                                            provide fresh perspectives, save time and effort, and help you
                                ...
                                <div className="accordion-item mb-3">
                                    ...
                                    >
                                        <div className="accordion-body mt-3">
                                            The timeframe for achieving results depends on the nature of the
                                            project and its complexity. Short-term campaigns may yield
                                            results within weeks, while long-term strategies may take
                                            several months or even years to show significant impact.
                                            Effective collaboration, clear goals, and realistic expectations
                                ...
                                <div className="accordion-item mb-3">
                                    ...
                                    >
                                        <div className="accordion-body mt-3">
                                            ...
                                            project. Common metrics include increased sales or revenue,
                                            improved brand recognition, website traffic growth, social media
                                            engagement, lead generation, customer acquisition, or positive
                                            media coverage. Work with the agency to define key performance
                                ...
                                <div className="accordion-item mb-3">
                                    <div className="accordion-header font-base" id="heading-8">
                                        <button
                                            className="accordion-button fw-semibold rounded"
                                            type="button"
                                            data-bs-toggle="collapse"
                                    ...
                                    >
                                        <div className="accordion-body mt-3">
                                            Yes, you can terminate your contract with an agency if you're
                                            not satisfied, although the specific terms of termination should
                                            be outlined in the contract. It's advisable to communicate any
                                            concerns or issues with the agency first to see if they can
                                            address them. If the relationship is not salvageable, you may
                                            need to follow the agreed-upon termination procedures.
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="bg-primary bg-opacity-10 rounded p-4 p-sm-5">
                        <div className="row">
                            ...
                            <div className="col-lg-7 text-center mx-auto">
                                ...
                                {/* Button */}
                                <a href="/Contact" className="btn btn-lg btn-dark mb-0">
                                    Contact us
                                </a>
                            </div>
                        </div>{" "}
