                ...
                >
                    ...
                    <figure className="position-absolute top-0 start-0 mt-n8 ms-n9">
                        <svg
                            ...
                            height="834px"
                            viewBox="0 0 775 834"
                            style={{ enableBackground: "new 0 0 775 834", opacity: "0.05" }}
                            xmlSpace="preserve"
                        >
                    ...
                    <div className="position-absolute top-0 end-0 mt-n3 me-n4">
                        <img
                            src="/Image/element/decoration-pattern-2.svg"
                            style={{ opacity: "0.05" }}
                            alt=""
                        />
                    </div>
                    <div className="container position-relative mt-5">
                            ...
                            <div className="col-lg-8 col-xxl-7">
                                <div className="row g-4">
                                    ...
                                    <div className="col-6 col-md-4">
                                        ...
                                        <ul className="nav flex-column">
                                            <li className="nav-item">
                                                <a className="nav-link pt-0" href="/About">
                                                    About us
                                                </a>
                                            </li>
                                            <li className="nav-item">
                                    ...
                                    <div className="col-md-4">
                                        ...
                                        <div className="row g-2 mt-2 mb-4 mb-sm-5">
                                            {/* Google play store button */}
                                            <div className="col-5 col-sm-4 col-md-6">
                                                <a href="/Home">
                                                    <img src="/Image/element/google-play.svg" alt="" />
                                                </a>
                                            </div>
                                            {/* App store button */}
                                            <div className="col-5 col-sm-4 col-md-6">
                                                <a href="/Home">
                                                    <img
                                                        src="/Image/element/app-store.svg"
                                                        alt="app-store"
                                                    />
                                                </a>
                                            </div>
                        ...
                        <div className="d-md-flex justify-content-between align-items-center text-center text-lg-start py-4">
                            ...
                            <div className="text-body">
                                Copyrights ©2024 Mizzle. Build by Tech Solution..... 
                                
                                .
                            </div>
                            {/* copyright links*/}
                            {/* Language selector */}
                            <div className="dropdown dropup text-center text-md-end mt-3 mt-md-0">
                                <a
                                    className="dropdown-toggle btn btn-sm btn-light mb-0"
                                    href="#"
                                    role="button"
                                    id="languageSwitcher"
